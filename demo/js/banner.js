...
define(["jquery"],function($){
	...
	Banner.prototype.initUI = function(){
		...
		for(let i=0;i<this.imgArr.length;i++){
			imgStr += "<img src='"+this.imgArr[i]+"' style='position:absolute;left:-10000px;top:0px;width:100%;height:100%;display:none'/>";
		}
		...
		//3、动态创建按钮
		let btnStr = "<ul style='position:absolute;display:flex;justify-content:center;left:0;right:0;margin:0 auto;bottom:30px;'>";
		for(let i=0;i<this.imgArr.length;i++){
